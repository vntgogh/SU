...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAName = "Karmine Corp";
  ...
  public static final String teamAMainBotAvatar = "avatars/pika.png"; //path relative to location of ant build.xml file
  public static final double teamAMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamAMainBotSpeed = 50, //1 unit = 1mm, distance performed at step movement
  ...
  //---TEAM-B-PARAMETERS---//
  //-----------------------//
  public static final String teamBName = "Gentle Mates";
  ...
  public static final String teamBMainBotAvatar = "avatars/ronflex.png"; //path relative to location of ant build.xml file
  public static final double teamBMainBotRadius = 50, //1 unit = 1mm, body radius
                             ...
                             teamBMainBotSpeed = 15, //1 unit = 1mm, distance performed at step movement
